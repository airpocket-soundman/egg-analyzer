...
/// Input buffer sizes.
#define NNABLART_MAINRUNTIME_INPUT0_SIZE (512)
...
/// Output buffer sizes.
#define NNABLART_MAINRUNTIME_OUTPUT0_SIZE (100)
/// Pointer of allocated buffer.
float* nnablart_mainruntime_output_buffer(void* context, int index);
/// Number of parameter buffers.
#define NNABLART_MAINRUNTIME_NUM_OF_PARAM_BUFFERS (12)
/// Parameter buffer sizes.
#define NNABLART_MAINRUNTIME_PARAM0_SIZE (1536)
#define NNABLART_MAINRUNTIME_PARAM1_SIZE (3)
#define NNABLART_MAINRUNTIME_PARAM2_SIZE (3)
#define NNABLART_MAINRUNTIME_PARAM3_SIZE (3)
#define NNABLART_MAINRUNTIME_PARAM4_SIZE (3)
#define NNABLART_MAINRUNTIME_PARAM5_SIZE (3)
#define NNABLART_MAINRUNTIME_PARAM6_SIZE (300)
#define NNABLART_MAINRUNTIME_PARAM7_SIZE (100)
#define NNABLART_MAINRUNTIME_PARAM8_SIZE (100)
#define NNABLART_MAINRUNTIME_PARAM9_SIZE (100)
#define NNABLART_MAINRUNTIME_PARAM10_SIZE (100)
#define NNABLART_MAINRUNTIME_PARAM11_SIZE (100)
/// Pointer of allocated buffer.
