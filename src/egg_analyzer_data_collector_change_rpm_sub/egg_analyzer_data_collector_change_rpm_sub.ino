...
//#define VMAX                    100             //　モーターの最高速　100で1回転/sec相当（ちがうかも  30 100
#define VMAX                    30
#define CYCLETIME               800000          //  Sinカーブに沿って加減速するさいのSin波周期 600000us = 600ms = 0.6sec900000,4000000
//#define CYCLETIME               4000000
#define NUMBER_OF_TIME_SEGMENTS 500             //  sinカーブをこの数値で分周して疑似サインカーブを生成する
#define NUMBER_OF_REPEAT        4               //  sin加速を繰り返す回数
//#define NUMBER_OF_REPEAT        1
#define MOVE_TIME               3000000         //周り続ける時間(us)
...
void loop()
{
  ...
  delayMicroseconds(1000);
  int delaytime = 100;
  for (int i = 0; i <= MOVE_TIME / 2 /msgdata; i++){
    //delaytime -= 1;
    //if (delaytime < msgdata){
    //  delaytime = msgdata;
    //}
    stepMotor(delaytime);
  }
